    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> {
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/rounds/*/criteria").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/teams/*/ai-review")
                .hasAnyRole("ORGANIZER", "JUDGE", "MENTOR")
                .requestMatchers(HttpMethod.GET, "/api/v1/teams/*/ai-reviews")
                .hasAnyRole("ORGANIZER", "JUDGE", "MENTOR")
