...
@Testcontainers
class RegistrationOwnershipIntegrationTest {

    @Container
    static final PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("seal_hackathon_registration_ownership_test")
    ...
    @Test
    void foreignOrganizerCannotListEventTeams() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/events/" + event.getId() + "/teams")
