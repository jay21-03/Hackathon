...
export function JudgeAiReviewPage() {
  ...
  const teamsQuery = useQuery({
    ...
    queryKey: ["judge", "board-teams", boardId],

    queryFn: () => fetchJudgeBoardTeams(Number(boardId)),
  ...
  const reviewQuery = useQuery({
    ...
    queryKey: ["judge", "ai-review", teamId],
  ...
  const historyQuery = useQuery({
    queryKey: ["judge", "ai-review-history", teamId],
  ...
  return (
    ...
    <div className="space-y-lg">
      ...
      <PageHeader
        ...
        description="Rubric R1/R2 tham khảo trước buổi chấm — không thay thế phiếu điểm chính thức."
      ...
      {boardOptions.length === 0 ? (
        ...
        <EmptyState icon="psychology" title="Chưa có phân công" description="Chờ BTC gán giám khảo cho bảng." />
